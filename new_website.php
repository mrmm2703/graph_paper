...
if (isset($_POST["title"])) {
    if (strlen($_POST["title"]) == 0) {
        ...
        if ($db_con->connect()) {
            $lib_item_id = $db_con->insertNewWebsite($_GET["project_id"], $_POST["title"], $_POST["summary"], $_POST["publisheddate"], $_POST["publisher"], $_POST["websitetitle"], $_POST["url"], $_POST["accesseddate"]);
...
<html>
    ...
    <body>
        ...
        <form method="POST">
            ...
            <label for="accesseddate">Accessed Date:</label>
            <input type="date" name="accesseddate" placeholder="Accessed Date"><br><br>
